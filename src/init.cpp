 ...
 */
static const char* BITCOIN_PID_FILENAME = "ufocoind.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/fiscalobject/ufo>";
    const std::string URL_WEBSITE = "<https://ufobject.com>";
