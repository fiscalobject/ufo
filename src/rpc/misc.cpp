...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ufoaddress\"\n"
            "\nReturn information about the given ufo address.\n"
            "\nArguments:\n"
            "1. \"ufoaddress\"     (string, required) The ufo address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ufoaddress\", (string) The ufo address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"Bybvm6vc9ibg17BHVDkb5Fxy7BsaEXyhSo\"")
            + HelpExampleRpc("validateaddress", "\"Bybvm6vc9ibg17BHVDkb5Fxy7BsaEXyhSo\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are ufo addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) ufo address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"Bybvm6vc9ibg17BHVDkb5Fxy7BsaEXyhSo\\\",\\\"CAxYwu33FDgJ16ssjfGndWZapnHqMAZ7E8\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"Bybvm6vc9ibg17BHVDkb5Fxy7BsaEXyhSo\\\",\\\"CAxYwu33FDgJ16ssjfGndWZapnHqMAZ7E8\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ufoaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ufoaddress\"  (string, required) The ufo address to use for the signature.\n"
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}")
            );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"6ejp6MVdCv1R4DS3kRdCibKf7TLbKknvFJ\"]}")
        );
