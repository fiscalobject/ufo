...
namespace Checkpoints
{
    ...
    static const CCheckpointData data = {
        &mapCheckpoints,
        1373776928, // * UNIX timestamp of last checkpoint block
        4171,    // * total number of transactions between genesis and last checkpoint
    ...
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        (   0, uint256("0x45b4e55bddf20dfeb69ef2a35dd36f58dd45d5f4582c1a4ca1c1b78eef8f8c37"))
        ;
