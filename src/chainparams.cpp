...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000021414e1a5ce719");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x914892b886411cdd0888d139129c11acedbc0386216b33bb5058787d0a037b5f"); //1295768
        ...
        vSeeds.emplace_back("dns.seed1.ufocoin.net", false);
        vSeeds.emplace_back("dns.seed2.ufocoin.net", false);
        vSeeds.emplace_back("dns.seed3.ufocoin.net", false);
        vSeeds.emplace_back("dns.seed4.ufocoin.net", false);
        vSeeds.emplace_back("dns.dnsseed.lowecraft.it", false);
        vSeeds.emplace_back("dns.dnsseed.ufocoinnode.com", false);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ufocoin.net", false);
