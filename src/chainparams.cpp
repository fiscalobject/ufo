...
public:
    CMainParams() {
        ...
        consensus.nMinerConfirmationWindow = 13440; // Two weeks
        ...
        checkpointData = (CCheckpointData) {
            ...
            1516954262, // * UNIX timestamp of last checkpoint block
            1496331,   // * total number of transactions between genesis and last checkpoint
