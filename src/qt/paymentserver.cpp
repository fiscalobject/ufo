...
const QString BITCOIN_IPC_PREFIX("ufo:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ufo-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ufo-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ufo-paymentrequest";
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ufo: URI
        {
...
//
// OSX-specific way of handling ufo: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ufo: URIs
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ufo: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
