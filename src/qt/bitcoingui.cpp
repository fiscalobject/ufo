...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About UFO Core"), this);
    aboutAction->setStatusTip(tr("Show information about UFO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UFO Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("UFO Core client") + " " + networkStyle->getTitleAddText();
